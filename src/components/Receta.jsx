...
const Receta = ({receta}) => {
    ...
    //Configuración del model de material UI
    ...
    //Muetsra y formatea los ingredientes
    const mostrarIngredientes = informacion => {
        let ingredientes = [];
        for(let i = 1; i < 16; i++ ){
            if(informacion[`strIngredient${i}`]){
                ingredientes.push(                    
                <li key={informacion.idDrink}>
                ...
                <div className="card-body">
                    ...
                    >
                        <div style={modalStyle} className={classes.paper}>
                            ...
                            <img className="img-fluid my-4" alt="" src={informacion.strDrinkThumb}></img>
